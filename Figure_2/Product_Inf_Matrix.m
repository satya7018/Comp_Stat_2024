function y = Product_Inf_Matrix(theta,x)
%theta = [1 2 0.5 0.4 2];
%x = [0.3 0.2 0.4 0.1];
...
D_p11_AA_t1 = pi1_AA*Dpi1_t1_AA;
D_p11_AB_t1 = pi1_AA*Dpi1_t1_AB;
D_p11_BA_t1 = pi1_AA*Dpi1_t1_BA;
D_p11_BB_t1 = pi1_AA*Dpi1_t1_BB;


% Derivative of p_11 wrt \beta^{*}
D_p11_AA_t2 = pi1_AA*Dpi1_t2_AA;
D_p11_AB_t2 = pi1_AB*Dpi1_t2_AB;
D_p11_BA_t2 = pi1_BA*Dpi1_t1_BA;
D_p11_BB_t2 = pi1_BB*Dpi1_t1_BB;


% Derivative of p_11 wrt \tau^{*}
D_p11_AA_t3 = pi1_AA*Dpi1_t3_AA;
D_p11_AB_t3 = pi1_AB*Dpi1_t3_AB;
D_p11_BA_t3 = pi1_BA*Dpi1_t3_BA;
D_p11_BB_t3 = pi1_BB*Dpi1_t3_BB;


% Derivative of p_11 wrt \gamma^{*}
D_p11_AA_t4 = pi1_AA*Dpi1_t4_AA;
D_p11_AB_t4 = pi1_AB*Dpi1_t4_AB;
D_p11_BA_t4 = pi1_BA*Dpi1_t4_BA;
D_p11_BB_t4 = pi1_BB*Dpi1_t4_BB;
