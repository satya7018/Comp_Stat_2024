function y = Frank_Inf_Matrix(theta,x)
 %theta = [0 0 0 0 -3];
% 
...
R1_AA = theta(5)*(exp(-theta(5))-1+(exp(-theta(5)*pi1_AA)-1)*(exp(-theta(5)*pi2_AA)-1));
R1_AB = theta(5)*(exp(-theta(5))-1+(exp(-theta(5)*pi1_AB)-1)*(exp(-theta(5)*pi2_AB)-1));
R1_BA = theta(5)*(exp(-theta(5))-1+(exp(-theta(5)*pi1_BA)-1)*(exp(-theta(5)*pi2_BA)-1));
R1_BB = theta(5)*(exp(-theta(5))-1+(exp(-theta(5)*pi1_BB)-1)*(exp(-theta(5)*pi2_BB)-1));

R2_AA_t1 = ((1-exp(-theta(5)*pi2_AA))*theta(5)*exp(-theta(5)*pi1_AA))*Dpi1_t1_AA + ((1-exp(-theta(5)*pi1_AA))*theta(5)*exp(-theta(5)*pi2_AA))*Dpi2_t1_AA;
R2_AB_t1 = ((1-exp(-theta(5)*pi2_AB))*theta(5)*exp(-theta(5)*pi1_AB))*Dpi1_t1_AB + ((1-exp(-theta(5)*pi1_AB))*theta(5)*exp(-theta(5)*pi2_AB))*Dpi2_t1_AB;
R2_BA_t1 = ((1-exp(-theta(5)*pi2_BA))*theta(5)*exp(-theta(5)*pi1_BA))*Dpi1_t1_BA + ((1-exp(-theta(5)*pi1_BA))*theta(5)*exp(-theta(5)*pi2_BA))*Dpi2_t1_BA;
R2_BB_t1 = ((1-exp(-theta(5)*pi2_BB))*theta(5)*exp(-theta(5)*pi1_BB))*Dpi1_t1_BB + ((1-exp(-theta(5)*pi1_BB))*theta(5)*exp(-theta(5)*pi2_BB))*Dpi2_t1_BB;
% Derivative of p_11 wrt \nu
D_p11_AA_t1 = -R2_AA_t1/R1_AA;
D_p11_AB_t1 = -R2_AB_t1/R1_AB;
D_p11_BA_t1 = -R2_BA_t1/R1_BA;
D_p11_BB_t1 = -R2_BB_t1/R1_BB;



R2_AA_t2 = ((1-exp(-theta(5)*pi2_AA))*theta(5)*exp(-theta(5)*pi1_AA))*Dpi1_t2_AA + ((1-exp(-theta(5)*pi1_AA))*theta(5)*exp(-theta(5)*pi2_AA))*Dpi2_t2_AA;
R2_AB_t2 = ((1-exp(-theta(5)*pi2_AB))*theta(5)*exp(-theta(5)*pi1_AB))*Dpi1_t2_AB + ((1-exp(-theta(5)*pi1_AB))*theta(5)*exp(-theta(5)*pi2_AB))*Dpi2_t2_AB;
R2_BA_t2 = ((1-exp(-theta(5)*pi2_BA))*theta(5)*exp(-theta(5)*pi1_BA))*Dpi1_t2_BA + ((1-exp(-theta(5)*pi1_BA))*theta(5)*exp(-theta(5)*pi2_BA))*Dpi2_t2_BA;
R2_BB_t2 = ((1-exp(-theta(5)*pi2_BB))*theta(5)*exp(-theta(5)*pi1_BB))*Dpi1_t2_BB + ((1-exp(-theta(5)*pi1_BB))*theta(5)*exp(-theta(5)*pi2_BB))*Dpi2_t2_BB;
% Derivative of p_11 wrt \beta^{*}
D_p11_AA_t2 = -R2_AA_t2/R1_AA;
D_p11_AB_t2 = -R2_AB_t2/R1_AB;
D_p11_BA_t2 = -R2_BA_t2/R1_BA;
D_p11_BB_t2 = -R2_BB_t2/R1_BB;

R2_AA_t3 = ((1-exp(-theta(5)*pi2_AA))*theta(5)*exp(-theta(5)*pi1_AA))*Dpi1_t3_AA + ((1-exp(-theta(5)*pi1_AA))*theta(5)*exp(-theta(5)*pi2_AA))*Dpi2_t3_AA;
R2_AB_t3 = ((1-exp(-theta(5)*pi2_AB))*theta(5)*exp(-theta(5)*pi1_AB))*Dpi1_t3_AB + ((1-exp(-theta(5)*pi1_AB))*theta(5)*exp(-theta(5)*pi2_AB))*Dpi2_t3_AB;
R2_BA_t3 = ((1-exp(-theta(5)*pi2_BA))*theta(5)*exp(-theta(5)*pi1_BA))*Dpi1_t3_BA + ((1-exp(-theta(5)*pi1_BA))*theta(5)*exp(-theta(5)*pi2_BA))*Dpi2_t3_BA;
R2_BB_t3 = ((1-exp(-theta(5)*pi2_BB))*theta(5)*exp(-theta(5)*pi1_BB))*Dpi1_t3_BB + ((1-exp(-theta(5)*pi1_BB))*theta(5)*exp(-theta(5)*pi2_BB))*Dpi2_t3_BB;
% Derivative of p_11 wrt \tau^{*}
D_p11_AA_t3 = -R2_AA_t3/R1_AA;
D_p11_AB_t3 = -R2_AB_t3/R1_AB;
D_p11_BA_t3 = -R2_BA_t3/R1_BA;
D_p11_BB_t3 = -R2_BB_t3/R1_BB;

R2_AA_t4 = ((1-exp(-theta(5)*pi2_AA))*theta(5)*exp(-theta(5)*pi1_AA))*Dpi1_t4_AA + ((1-exp(-theta(5)*pi1_AA))*theta(5)*exp(-theta(5)*pi2_AA))*Dpi2_t4_AA;
R2_AB_t4 = ((1-exp(-theta(5)*pi2_AB))*theta(5)*exp(-theta(5)*pi1_AB))*Dpi1_t4_AB + ((1-exp(-theta(5)*pi1_AB))*theta(5)*exp(-theta(5)*pi2_AB))*Dpi2_t4_AB;
R2_BA_t4 = ((1-exp(-theta(5)*pi2_BA))*theta(5)*exp(-theta(5)*pi1_BA))*Dpi1_t4_BA + ((1-exp(-theta(5)*pi1_BA))*theta(5)*exp(-theta(5)*pi2_BA))*Dpi2_t4_BA;
R2_BB_t4 = ((1-exp(-theta(5)*pi2_BB))*theta(5)*exp(-theta(5)*pi1_BB))*Dpi1_t4_BB + ((1-exp(-theta(5)*pi1_BB))*theta(5)*exp(-theta(5)*pi2_BB))*Dpi2_t4_BB;
% Derivative of p_11 wrt \gamma^{*}
D_p11_AA_t4 = -R2_AA_t4/R1_AA;
D_p11_AB_t4 = -R2_AB_t4/R1_AB;
D_p11_BA_t4 = -R2_BA_t4/R1_BA;
D_p11_BB_t4 = -R2_BB_t4/R1_BB;
...
a_AA = ((exp(-theta(5))*(exp(-theta(5)*pi1_AA)-1)*(exp(-theta(5)*pi2_AA)-1))/(exp(-theta(5))-1));
a_AB = ((exp(-theta(5))*(exp(-theta(5)*pi1_AB)-1)*(exp(-theta(5)*pi2_AB)-1))/(exp(-theta(5))-1));
a_BA = ((exp(-theta(5))*(exp(-theta(5)*pi1_BA)-1)*(exp(-theta(5)*pi2_BA)-1))/(exp(-theta(5))-1));
a_BB = ((exp(-theta(5))*(exp(-theta(5)*pi1_BB)-1)*(exp(-theta(5)*pi2_BB)-1))/(exp(-theta(5))-1));

b_AA = ((exp(-theta(5)*pi1_AA)-1)*(pi2_AA*exp(-theta(5)*pi2_AA))+(exp(-theta(5)*pi2_AA)-1)*(pi1_AA*exp(-theta(5)*pi1_AA)));
b_AB = ((exp(-theta(5)*pi1_AB)-1)*(pi2_AB*exp(-theta(5)*pi2_AB))+(exp(-theta(5)*pi2_AB)-1)*(pi1_AB*exp(-theta(5)*pi1_AB)));
b_BA = ((exp(-theta(5)*pi1_BA)-1)*(pi2_BA*exp(-theta(5)*pi2_BA))+(exp(-theta(5)*pi2_BA)-1)*(pi1_BA*exp(-theta(5)*pi1_BA)));
b_BB = ((exp(-theta(5)*pi1_BB)-1)*(pi2_BB*exp(-theta(5)*pi2_BB))+(exp(-theta(5)*pi2_BB)-1)*(pi1_BB*exp(-theta(5)*pi1_BB)));

D_C_AA = (-C_AA/theta(5))-((a_AA-b_AA)/(R1_AA));
D_C_AB = (-C_AB/theta(5))-((a_AB-b_AB)/(R1_AB));
D_C_BA = (-C_BA/theta(5))-((a_BA-b_BA)/(R1_BA));
D_C_BB = (-C_BB/theta(5))-((a_BB-b_BB)/(R1_BB));
