...
% Optimal design based on H3, using uniform prior and Product copula
xp = [0.346, 0.268, 0.239, 0.147];



fval11 = BCD_Frank_Uniform(x1,lb1,ub1)/BCD_Frank_Uniform(xp,lb1,ub1);

fval21 = BCD_Gumbel_Uniform(x2,lb2,ub2)/BCD_Gumbel_Uniform(xp,lb2,ub2);

fval31 = BCD_Clayton_Uniform(x3,lb3,ub3)/BCD_Clayton_Uniform(xp,lb3,ub3);

fval41 = BCD_Normal_Uniform(x4,lb4,ub4)/BCD_Normal_Uniform(xp,lb4,ub4);
